...
subroutine GetRho( xstart1, ystart1,zstart1,  width_x,  width_y, width_z,  rho)bind(C, name="GetRho")
    
    integer(C_INT), value ::  xstart1, ystart1,zstart1, width_x,  width_y, width_z
    ...
    do  i = xstart1,xend1
        do j=ystart1,yend1
            do k=zstart1,zend1
                ...
                q=j-ystart1
                m=k-zstart1
                rho(p*width_y*width_z+q*width_z+m+1)=FO%RhoOne(xstart1,ystart1,zstart1)
